const CACHE = "lrers-site-v0.2.0";
const ASSETS = ["./","index.html","assets/css/styles.css","assets/js/config.js","assets/js/api.js","assets/js/views.js","assets/js/app.js","assets/img/logo.svg","assets/img/lrers-server-logo.jpg"];
